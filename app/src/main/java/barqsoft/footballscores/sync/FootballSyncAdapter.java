...
public class FootballSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void getData (String timeFrame)
    {
        ...
        try {
            ...
            m_connection.addRequestProperty("X-Auth-Token", barqsoft.footballscores.BuildConfig.FOOTBALL_API_KEY);//m_connection.addRequestProperty("X-Auth-Token",getString(R.string.api_key));
        ...
        try {
            ...
            for(int i = 0;i < matches.length();i++)
            {
                        ...
                        League.equals(PRIMERA_DIVISION)     )
                {
                    ...
                    Log.d(LOG_TAG,"Match Details before insert:");
                    Log.d(LOG_TAG,"match_id:" + match_id);
                    Log.d(LOG_TAG,"mDate:" + mDate);
                    Log.d(LOG_TAG,"mTime:" + mTime);
                    Log.d(LOG_TAG,"Home:" + Home);
                    Log.d(LOG_TAG,"Away:" + Away);
                    Log.d(LOG_TAG,"Home_goals:" + Home_goals);
                    Log.d(LOG_TAG,"Away_goals:" + Away_goals);
                    Log.d(LOG_TAG,"League:" + League);
                    Log.d(LOG_TAG,"match_day:" + match_day);
...
//            getContext().getContentResolver().delete(DatabaseContract.BASE_CONTENT_URI,
...
//                    new String[] {Long.toString(dayTime.setJulianDay(julianStartDay-1))});
    ...
    public static Account getSyncAccount(Context context) {
        ...
        Account newAccount = new Account(//"Football Scores","barqsoft.footballscores");
